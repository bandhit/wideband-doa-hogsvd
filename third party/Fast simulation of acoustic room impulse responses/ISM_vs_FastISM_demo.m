...
while okflag==0
    ...
    [alpha,okflag] = ISM_AbsCoeff('t60',T60,room,weights,'sabine'); 
	alpha
    if okflag==1, 
...
X_rcv
room
fastRIR = fast_ISM_RoomResp(Fs,beta,'t60',T60,X_src,X_rcv,room);
fprintf('done!\n');
...
plot(fastRIR_tvec, 20 * log10(abs(fastRIR)))
