...
addpath('model/');
sam_path = 'output/record/d5-ch8-src2';
...
% real environment
n_src          = 2;
real_x_deg_vec = [ 65; 150];
real_z_deg_vec = [ 55; 100];
...
writetable(cell2table([legend_name_cel, data_mean_deg_cel]),   strcat('doa_np_2_real_mean',   '.xls'));
writetable(cell2table([legend_name_cel, data_mean_x_deg_cel]), strcat('doa_np_2_real_mean_x', '.xls'));
writetable(cell2table([legend_name_cel, data_mean_z_deg_cel]), strcat('doa_np_2_real_mean_z', '.xls'));
writetable(cell2table([legend_name_cel, data_std_deg_cel]),    strcat('doa_np_2_real_std',    '.xls'));
writetable(cell2table([legend_name_cel, data_std_x_deg_cel]),  strcat('doa_np_2_real_std_x',  '.xls'));
writetable(cell2table([legend_name_cel, data_std_z_deg_cel]),  strcat('doa_np_2_real_std_z',  '.xls'));
writetable(cell2table([legend_name_cel, data_rmse_deg_cel,   data_all_rmse_deg_cel]),   strcat('doa_np_2_real_rmse', '.xls'));
writetable(cell2table([legend_name_cel, data_rmse_x_deg_cel, data_all_rmse_x_deg_cel]), strcat('doa_np_2_real_rmse_x', '.xls'));
writetable(cell2table([legend_name_cel, data_rmse_z_deg_cel, data_all_rmse_z_deg_cel]), strcat('doa_np_2_real_rmse_z', '.xls'));
