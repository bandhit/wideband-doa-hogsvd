...
writetable(cell2table([legend_name_cel, data_mean_deg_cel]),   strcat('doa_np_1_real_mean',   '.xls'));
writetable(cell2table([legend_name_cel, data_mean_x_deg_cel]), strcat('doa_np_1_real_mean_x', '.xls'));
writetable(cell2table([legend_name_cel, data_mean_z_deg_cel]), strcat('doa_np_1_real_mean_z', '.xls'));
writetable(cell2table([legend_name_cel, data_std_deg_cel]),    strcat('doa_np_1_real_std',    '.xls'));
writetable(cell2table([legend_name_cel, data_std_x_deg_cel]),  strcat('doa_np_1_real_std_x',  '.xls'));
writetable(cell2table([legend_name_cel, data_std_z_deg_cel]),  strcat('doa_np_1_real_std_z',  '.xls'));
writetable(cell2table([legend_name_cel, data_rmse_deg_cel,   data_all_rmse_deg_cel]),   strcat('doa_np_1_real_rmse', '.xls'));
writetable(cell2table([legend_name_cel, data_rmse_x_deg_cel, data_all_rmse_x_deg_cel]), strcat('doa_np_1_real_rmse_x', '.xls'));
writetable(cell2table([legend_name_cel, data_rmse_z_deg_cel, data_all_rmse_z_deg_cel]), strcat('doa_np_1_real_rmse_z', '.xls'));
