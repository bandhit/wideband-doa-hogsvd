...
function [norm_mat3, sort_re_eig_val_vec] = music_frq_l_n_src ( ...
    src_mat, n_sen_vec, d_sen, lamb, n_src, src_frq, cen_frq, ...
        ...
        for i = 1: 1: n_ang_x
            for j = 1: 1: n_ang_y
                for k = 1: 1: n_ang_z
                    ...
                    norm_mat3(i, j, k) = 1 / (ster_vec' * sqr_e_mat * ster_vec);
                end
            end
        end
