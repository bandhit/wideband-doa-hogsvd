...
%
% Description : G. Su et al., The Signal Subspace Approach for Multiple Wide-band Emitter Location, 
%               IEEE, 1983.
%
...
function [ang_x_rad_vec, ang_z_rad_vec] = ...
    ...
    for i_ang = 1: 1: n_ang
        ...
        for i_frq = 1: 1: n_frq
            ...
            sum_cost_x  = sum_cost_x + (ster_x_vec' * sqr_e_x_mat * ster_x_vec);
            sum_cost_z  = sum_cost_z + (ster_z_vec' * sqr_e_z_mat * ster_z_vec);
        end
        
        norm_x_vec(i_ang, 1) = 1 / sum_cost_x;
        norm_z_vec(i_ang, 1) = 1 / sum_cost_z;
    end
