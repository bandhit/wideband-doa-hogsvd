...
%
% Description : K. Okane et al., Resolution Improvement of Wideband Direction-of-Arrival 
%               Estimation "Squared-TOPS", IEEE, 2010.
%
...
function [ang_x_rad_vec, ang_z_rad_vec] = ...
    ...
    for i_ang = 1: 1: n_ang
        ...
        for i_frq = 1: 1: n_frq
            ...
            d_x_mat = [d_x_mat, u_x_mat' * w_x_mat * w_x_mat' * u_x_mat]; %#ok<MHERM,AGROW>
            d_z_mat = [d_z_mat, z_x_mat' * w_z_mat * w_z_mat' * z_x_mat]; %#ok<MHERM,AGROW>
        end
