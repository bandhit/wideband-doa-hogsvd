...
function norm_mat = music_doa (v_mat, n_sen_vec, fc_src_frq, cen_frq, lamb, d_sen, n_rank_fc, ang_x_rad_vec, ang_z_rad_vec, ster_idx_cvec)
    ...
    for i_ang_x = 1: 1: n_ang_x
        for i_ang_z = 1: 1: n_ang_z
            ...
            norm_mat(i_ang_x, i_ang_z) = (ster_vec' * ster_vec) ./ (ster_vec' * sqr_e_x_mat * ster_vec);
        end
    end
end
