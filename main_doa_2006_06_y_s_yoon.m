...
for i_snr = 1: 1: n_snr
    parfor i_sam = 1: 1: n_sam
        ...
        [calc_x_rad_vec, calc_z_rad_vec] = ...
            doa_frq_n_src(post_stft_mat3, post_frq_vec, n_mic, d_mic, lamb, n_src, cen_frq, idx_ref, ang_rad_vec);
...
% save
is_pair = false;
save(fullfile(out_path, 'out_2006_06_y_s_yoon.mat'), ...
    'is_pair', ...
